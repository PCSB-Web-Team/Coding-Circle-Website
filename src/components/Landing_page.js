          ...
          <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-1/2 md:px-3">
              <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 class="text-4xl font-extrabold tracking-tight text-white-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  <span class="block xl:inline">
                    Here is a guide for you to direct you on the roadmap of{" "}
                  </span>
                  <span class="block text-indigo-600 xl:inline">
                    Success....
                  </span>
                </h1>
                <p class="mx-auto text-base text-white-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  Learn, Code, and Connect with fellow coders and seniors!
                </p>
                <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                  ...
                  <a
                    href="#_"
                    class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-white-600"
                  >
                    Learn More about PCSB
                  </a>
                </div>
              </div>
            </div>
      ...
      <section class="w-full  pt-7 pb-7 md:pt-20 md:pb-24">
        <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-white border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
          ...
          <div class="box-border order-first w-full text-white border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <p class="pt-4 pb-8 m-0 leading-7 text-white-700 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">
              The roadmap to the journey on how to begin with DSA
            </p>
        ...
        <div class="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-white border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
          <div class="box-border w-full text-white border-solid md:w-1/2 md:pl-6 xl:pl-32">
            ...
            <p class="pt-4 pb-8 m-0 leading-7 text-white-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">
              The roadmap to the journey on how to begin with Competitive
              Programming.
            </p>
            <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
              <li class="box-border relative py-1 pl-0 text-left text-white-500 border-solid">
          ...
          <div class="flex flex-wrap items-center -mx-3">
            <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
              <div class="w-full lg:max-w-md">
                ...
                <p class="mb-4 font-medium tracking-tight text-white-400 xl:mb-6">
                  Join Coding Circle today and embark on a journey of continuous
                  learning!
                </p>
                <ul>
                  <li class="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span class="font-medium text-white-500">
                  ...
                  <li class="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span class="font-medium text-white-500">
                      Getting Prepared for Placements!!
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div class="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <h2 class="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                class="absolute right-0 hidden w-12 h-12 -mt-2 -mr-16 text-white-200 lg:inline-block"
